...
jest.mock("../../../src/service-tokens/user-role/events/Create");
jest.mock("../../../src/service-tokens/user-role/events/Update");
jest.mock("../../../src/service-tokens/user-role/events/Delete");
const mockedCreateUserRole = mocked(createUserRole);

import { sendFailedResponse } from "../../../src/utilities/CloudFormationUtility";
jest.mock("../../../src/utilities/CloudFormationUtility");

import { handle } from "../../../src/service-tokens/user-role/UserRoleHandler";
...
const assertEventHandlingExpectations = (
  ...
  expect(createUserRole).toHaveBeenCalledTimes(createCalls);
  expect(updateUserRole).toHaveBeenCalledTimes(updateCalls);
  expect(deleteUserRole).toHaveBeenCalledTimes(deleteCalls);
